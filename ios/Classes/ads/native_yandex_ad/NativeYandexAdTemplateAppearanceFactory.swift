...
class NativeYandexAdTemplateAppearanceFactory {
    public static func fromTheme(theme: NativeYandexAdViewTheme) -> YMANativeTemplateAppearance {
    ...
    class YMALabelAppearanceFactory {
        public static func fromTheme(
            theme: NativeYandexAdViewTheme.NativeAdLabelTheme
        ) -> YMALabelAppearance {
    ...
    class YMAButtonAppearanceFactory {
        public static func fromTheme(
            theme: NativeYandexAdViewTheme.NativeAdButtonTheme
        ) -> YMAButtonAppearance {
    ...
    class YMARatingAppearanceFactory {
        public static func fromTheme(
            theme: NativeYandexAdViewTheme.NativeAdRatingTheme
        ) -> YMARatingAppearance {
